...
with pl.StringCache():
    x = (pl.read_csv(src_grp, dtypes={"id4":pl.Int32, "id5":pl.Int32, "id6":pl.Int32, "v1":pl.Int32, "v2":pl.Int32, "v3":pl.Float32}, low_memory=True, rechunk=True)
         .with_columns(pl.col(["id1", "id2", "id3"]).cast(pl.Categorical)))

in_rows = x.shape[0]
x.write_ipc("/tmp/tmp.ipc", future=True)
del x
