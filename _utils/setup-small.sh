...
sudo apt-get -qq install -y lsb-release software-properties-common wget curl git libcurl4-openssl-dev libssl-dev
sudo apt-get -qq install -y make
sudo apt-get -qq install -y libfontconfig1-dev
sudo apt-get -qq install -y libicu-dev pandoc zlib1g-dev libjpeg-dev libpng-dev libtiff-dev
